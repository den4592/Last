        ...
        firebaseAuth.signInWithEmailAndPassword(Email,Password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){   // task 성공 시
                    finish();
                    Toast.makeText(Login.this,"성공하였습니다",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Login.this,MainActivity.class));  //메인액티비티로 넘김
                    finish();
                }
                else{
                    Toast.makeText(Login.this,"이메일이나 비밀번호가 틀렸습니다",Toast.LENGTH_SHORT).show(); //실패
                }
